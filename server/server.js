...
const p1handgun = new Weapon('Handgun', 1000, 18, 12, 1, 0, 5, 1, 0);
const p1heavyRifle = new Weapon("Heavier Rifle", 2000, 25, 30, 3, 2, 10, 1, 0);
const p1lightRifle = new Weapon("Lighter Rifle", 2500, 20, 35, 3, 2, 15, 1, 0);
